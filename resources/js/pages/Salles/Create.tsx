...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Créer une salle', href: '#' },
];

export default function SalleCreate({ auth, vocations }: { auth: Auth; vocations: string[] }) {
        ...
        <AppLayout auth={auth} breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Créer une nouvelle salle</h1>
                </div>
