...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Accessoires',
        href: '/succursales-accessoire',
    }
];

export default function StockSuccursaleAccessoireIndex({ auth }: { auth: Auth }) {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            router.get(route('accessoires.index'), { search }, {
                preserveState: true,
                replace: true
            });
        }, 300);
    ...
    return (
        <AppLayout auth={auth} breadcrumbs={breadcrumbs}>
            <Head title="Stocks Accessoires" />
            <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <h1 className="text-2xl font-bold tracking-tight">Stocks Accessoires</h1>
