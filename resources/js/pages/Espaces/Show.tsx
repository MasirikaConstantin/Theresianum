...
const breadcrumbs = (espace: Espace): BreadcrumbItem[] => [
    {
        title: 'Dashboard',
        href: '/dashboard',
    },
...
export default function EspaceShow({ auth, espace, occupations }: PageProps) {
    ...
    const handleDelete = () => {
        router.delete(route('espaces.destroy', espace.id));
    };
    ...
    const reservationsActives = espace.reservations.filter(r => 
        ['confirmee', 'en_attente'].includes(r.statut)
    );

    const reservationsPassees = espace.reservations.filter(r => 
    ...
    return (
        <AppLayout auth={auth} breadcrumbs={breadcrumbs(espace)}>
            <Head title={espace.nom} />
            <div className="flex flex-1 flex-col gap-6 p-4 md:gap-8 md:p-6">
                {/* Header */}
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Link href={route('espaces.index')}>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    • Dernière mise à jour: {format(new Date(espace.updated_at), 'dd MMMM yyyy à HH:mm', { locale: fr })}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-2">
                        <Link href={route('reservations.create', { espace_id: espace.ref })}>
                            <Button>
                        ...
                        {canUpdate && (
                            <Link href={route('espaces.edit', espace.ref)}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>Informations de la espace</CardTitle>
                                <CardDescription>
                                    Détails complets de la configuration de la espace
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-lg font-semibold">{espace.nom}</p>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div>
                                            <Badge variant={getVocationBadgeVariant(espace.vocation)}>
                                                {getVocationLabel(espace.vocation)}
                                            </Badge>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div>
                                            <Badge variant={espace.disponible ? 'default' : 'secondary'}>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span>
                                                {format(new Date(espace.created_at), 'dd MMMM yyyy', { locale: fr })}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-3 flex-wrap">
                                        {getEquipementIcon(espace.equipements)}
                                    </div>
                            ...
                            <CardContent>
                                {reservationsActives.length > 0 ? (
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-muted-foreground">
                                            Aucune réservation active pour cette espace
                                        </p>
                                    </div>
                                )}
                            </CardContent>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-3">
                                <Link href={route('reservations.create', { espace_id: espace.ref })} className="w-full">
                                ...
                                {canUpdate && (
                                    <Link href={route('espaces.edit', espace.ref)} className="w-full">
                                        <Button variant="outline" className="w-full justify-start mb-3">
                                            <Pencil className="h-4 w-4 mr-2" />
                                            Modifier l'espace
                                        </Button>
                                ...
                                {canDelete && (
                                    <AlertDialog>
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                <AlertDialogTitle>Supprimer {espace.nom} ?</AlertDialogTitle>
                                                <AlertDialogDescription>
                                                    Cette action est irréversible. L'espace et toutes ses réservations associées seront définitivement supprimées.
                                                    {reservationsActives.length > 0 && (
