...
import { Auth, Chambre, type BreadcrumbItem } from '@/types';
...
export default function ChambreEdit({ auth, types, flash, chambre }: { auth: Auth; types: string[]; flash: { error: string; success: string }; chambre: Chambre }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('chambres.update', chambre.ref));
    };
        ...
        <AppLayout auth={auth} breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Modifier une chambre</h1>
                </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-4">
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Modification...' : 'Modifier la chambre'}
                            </Button>
