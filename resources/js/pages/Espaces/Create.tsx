...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Créer un espace', href: '#' },
];

export default function EspaceCreate({ auth, vocations }: { auth: Auth; vocations: string[] }) {
        ...
        <AppLayout auth={auth} breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight">Créer un nouvel espaces</h1>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2 md:col-span-2">
                                <Label htmlFor="nom">Nom de l'espaces *</Label>
                                <Input
                                    id="nom"
                                    value={data.nom}
                                    onChange={(e) => setData('nom', e.target.value)}
                                    placeholder="Ex: Espace Cristal, Espace anniversaire..."
                                    required
                                />
                        ...
                        <div className="flex gap-4">
                            <Button type="submit" disabled={processing}>
                                {processing ? 'Création...' : 'Créer l\'espace'}
                            </Button>
                            <Link href={route('espaces.index')}>
