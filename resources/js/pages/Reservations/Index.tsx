            ...
            <div className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-2xl font-bold tracking-tight">Réservations des salles</h1>
                    </div>
                            ...
                            {reservations.data.map((reservation: Reservation, index: number) => {
                                ...
                                return (
                                    <TableRow key={reservation.id}>
                                        ...
                                        <TableCell>
                                            <div className="flex gap-2">
                                                <Link href={route('reservations.show', reservation.ref)}>
                                                    <Button variant="outline" size="sm">
                                                        <Eye className="h-4 w-4" />
                                                    </Button>
                                                </Link>
                                                {canUpdate && (
                                                    <Link href={route('reservations.edit', reservation.ref)}>
                                                        <Button variant="outline" size="sm">
