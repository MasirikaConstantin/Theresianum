...
export default function ProduitEdit({ auth, produit, categories }: { auth: Auth; produit: any, categories: Categorie[] }) {
    ...
    const selectedCategory = categories.find(cat => cat.id === parseInt(data.categorie_id));
                        ...
                        >
                            <SelectTrigger className="w-full mt-2">
                                ...
                                placeholder="Sélectionner une catégorie" 
                                    {...(selectedCategory ? { 
                                        placeholder: selectedCategory.nom 
                                    } : {})}
                                />
                            </SelectTrigger>
                            <SelectContent>
